    ...
    extends NLS
{
    ...
    public static String AutoSortPropertyPage_Sort_settings_moved;
    public static String AutoSortPropertyPage_Transfer_or_clear_sort_settings;
    public static String AutoSortPropertyPage_Transfer;
    public static String AutoSortPropertyPage_Clear;
