...
import static com._1c.g5.v8.dt.metadata.mdclass.MdClassPackage.Literals.CONFIGURATION__DETAILED_INFORMATION;
 ...
 */
public final class ConfigurationDetailedInformationCheck
    extends AbstractUiStringCheck
{

    private static final String CHECK_ID = "configuration-detailed-information"; //$NON-NLS-1$
    private static final String PARAM_PATTERN_DEFAULT = ""; //$NON-NLS-1$

    @Inject
    public ConfigurationDetailedInformationCheck(IV8ProjectManager v8ProjectManager)
    {
        super(CONFIGURATION__DETAILED_INFORMATION, v8ProjectManager);
    }
    ...
    protected void configureCheck(CheckConfigurer builder)
    {
        ...
        builder.title("Configuration detailed information")
            .description("Configuration detailed information")
            .extension(new StandardCheckExtension(482, getCheckId(), CorePlugin.PLUGIN_ID))
            .topObject(CONFIGURATION)
            .checkTop()
            .features(CONFIGURATION__DETAILED_INFORMATION);
    }
    ...
    {
        return "Detailed information is empty for all languages";
    }

    @Override
    protected String getUiStringIsEmpty(String languageCode)
    {
        return MessageFormat.format("Detailed information for language \"{0}\" is empty", languageCode);
    }

    @Override
    protected String getUiStringShouldMatchPattern(String languageCode, String patternText)
    {
        return MessageFormat.format("Detailed information for language \"{0}\" should match pattern: \"{1}\"",
        ...
        IProgressMonitor monitor)
    {
        ...
        EMap<String, String> detailedInfo = config.getDetailedInformation();
        for (Entry<String, String> entry : detailedInfo)
        {
            ...
            if (!StringUtils.isBlank(model) && !model.equalsIgnoreCase(entry.getValue()))
            {
                ...
                resultAceptor.addIssue(
                    ...
                    CONFIGURATION__DETAILED_INFORMATION);
            }
        }
    }
