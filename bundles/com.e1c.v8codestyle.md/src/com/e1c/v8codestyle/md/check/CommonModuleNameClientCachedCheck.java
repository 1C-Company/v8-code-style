...
import static com.e1c.v8codestyle.md.CommonModuleTypes.CLIENT_CACHED;
...
/**
 * Check the postfix for a client module with the cached attribute.
 *
 * @author Artem Iliukhin
 */
public final class CommonModuleNameClientCachedCheck
    extends BasicCheck
{

    private static final String CHECK_ID = "common-module-name-client-cached"; //$NON-NLS-1$

    private final IV8ProjectManager v8ProjectManager;

    @Inject
    public CommonModuleNameClientCachedCheck(IV8ProjectManager v8ProjectManager)
    {
        super();
    ...
    protected void check(Object object, ResultAcceptor result, ICheckParameters parameters, IProgressMonitor monitor)
    {
        ...
        addResultAcceptor(CLIENT_CACHED, variant, module, result);
    }
