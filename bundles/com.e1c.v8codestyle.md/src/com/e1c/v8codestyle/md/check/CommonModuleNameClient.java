 ...
 *
 */
public class CommonModuleNameClient
    extends BasicCheck
{
        ...
        IProgressMonitor monitor)
    {
        ...
        if (excludeNamePattern != null && name.matches(excludeNamePattern))
        {
            return;
        }
        ...
        {
            String message =
                MessageFormat.format(Messages.CommonModuleNameClient_message, String.join(", ", nameSuffixs)); //$NON-NLS-1$
