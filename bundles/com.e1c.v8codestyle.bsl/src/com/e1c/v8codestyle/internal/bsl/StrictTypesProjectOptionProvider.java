    ...
    implements IProjectOptionProvider
{
    ...
    {
        return "Automatically add module strict-types annotation";
    }

    @Override
    public String getDescription()
    {
        return "This annotation will be aaded to module header to enable strict validation of module types.";
    }
