    ...
    extends NLS
{
    ...
    public static String DefinitionTypeVariableCheck_Description;

    public static String DefinitionTypeVariableCheck_Issue;

    public static String DefinitionTypeVariableCheck_Title;
