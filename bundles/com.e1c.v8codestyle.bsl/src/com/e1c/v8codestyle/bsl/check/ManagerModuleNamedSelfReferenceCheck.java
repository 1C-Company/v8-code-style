    ...
    extends BasicCheck
{
    ...
    private static final Map<EReference, EClass> MANAGERS_FOR_MDOBJECT = new ImmutableMap.Builder<EReference, EClass>()
         ...
         .put(MdClassPackage.Literals.CONFIGURATION__CHARTS_OF_CHARACTERISTIC_TYPES, MdClassPackage.Literals.CHART_OF_CHARACTERISTIC_TYPES)
         .put(MdClassPackage.Literals.CONFIGURATION__CHARTS_OF_ACCOUNTS, MdClassPackage.Literals.CHART_OF_ACCOUNTS)
         .put(MdClassPackage.Literals.CONFIGURATION__CHARTS_OF_CALCULATION_TYPES, MdClassPackage.Literals.CHART_OF_CALCULATION_TYPES)
         .put(MdClassPackage.Literals.CONFIGURATION__INFORMATION_REGISTERS, MdClassPackage.Literals.INFORMATION_REGISTER)
         .put(MdClassPackage.Literals.CONFIGURATION__ACCUMULATION_REGISTERS, MdClassPackage.Literals.ACCUMULATION_REGISTER)
    ...
    private IEObjectDescription getObjectFromScope(DynamicFeatureAccess source, EReference reference)
    {
        ...
        String fqn = topObjectFqnGenerator.generateStandaloneObjectFqn(MANAGERS_FOR_MDOBJECT.get(reference), source.getName());
