    ...
    extends NLS
{
    ...
    public static String FormItemsOneEventHandlerCheck_description;
    public static String FormItemsOneEventHandlerCheck_itemName_dot_eventName;
    public static String FormItemsOneEventHandlerCheck_the_handler_is_already_assigned_to_event;
    public static String FormItemsOneEventHandlerCheck_title;
