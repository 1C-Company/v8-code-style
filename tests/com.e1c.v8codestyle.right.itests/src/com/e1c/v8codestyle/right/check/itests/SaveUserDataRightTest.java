...
import com.e1c.v8codestyle.right.check.SaveUserDataRight;

/**
 * Tests for {@link SaveUserDataRight} check.
 *
 * @author Aleksandr Kapralov
 */
public class SaveUserDataRightTest
    extends CheckTestRights
{
    ...
    public void testStandartRoleCorrect() throws CoreException
    {
        ...
        updateRole(dtProject, "Role.StandartRole.Rights", CONFIGURATION_FQN, STANDART_ROLES, "SaveUserData");

        IBmObject top = getTopObjectByFqn("Role.SaveUserData.Rights", dtProject);
