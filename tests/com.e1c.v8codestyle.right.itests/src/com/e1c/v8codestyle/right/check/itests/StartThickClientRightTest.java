...
import com.e1c.v8codestyle.right.check.StartThickClientRight;

/**
 * Tests for {@link StartThickClientRight} check.
 *
 * @author Aleksandr Kapralov
 */
public class StartThickClientRightTest
    extends CheckTestRights
{
    ...
    public void testStandartRoleCorrect() throws CoreException
    {
        ...
        updateRole(dtProject, "Role.StandartRole.Rights", CONFIGURATION_FQN, STANDART_ROLES, "StartThickClient");

        IBmObject top = getTopObjectByFqn("Role.StartThickClient.Rights", dtProject);
