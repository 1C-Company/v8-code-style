 ...
 */
public class StartThinClientRightTest
    extends CheckTestRights
{
    ...
    public void testStandartRoleCorrect() throws CoreException
    {
        ...
        updateRole(dtProject, "Role.StandartRole.Rights", CONFIGURATION_FQN, STANDART_ROLES, "StartThinClient");

        IBmObject top = getTopObjectByFqn("Role.StartThinClient.Rights", dtProject);
