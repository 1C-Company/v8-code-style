...
import com.e1c.v8codestyle.right.check.StartExternalConnectionRight;

/**
 * Tests for {@link StartExternalConnectionRight} check.
 *
 * @author Aleksandr Kapralov
 */
public class StartExternalConnectionRightTest
    extends CheckTestRights
{
    ...
    public void testStandartRoleCorrect() throws CoreException
    {
        ...
        updateRole(dtProject, "Role.StandartRole.Rights", CONFIGURATION_FQN, STANDART_ROLES, "StartExternalConnection");

        IBmObject top = getTopObjectByFqn("Role.StartExternalConnection.Rights", dtProject);
